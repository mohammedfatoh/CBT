    ...
    public partial class RenameIdentityTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Eximinations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Eximinations_Patients_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    patient_Id = table.Column<int>(type: "int", nullable: false),
                    PatientId = table.Column<int>(type: "int", nullable: true),
                    Exmination_id = table.Column<int>(type: "int", nullable: false),
                    eximinationId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Eximinations_PatientId",
                table: "Eximinations",
                column: "PatientId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Roleclaims _Roles_RoleId",
                table: "Roleclaims ",
                column: "RoleId",
                principalTable: "Roles",
                principalColumn: "Id",
